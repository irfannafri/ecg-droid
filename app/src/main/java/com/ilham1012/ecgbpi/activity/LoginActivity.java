...
import com.ilham1012.ecgbpi.app.AppController;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (session.isLoggedIn()){
            ...
            Intent intent = new Intent(LoginActivity.this, DashboardNewActivity.class);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        Log.e(TAG, "Login Error: " + errorMsg + " , error : " + jObj.getBoolean("error"));
